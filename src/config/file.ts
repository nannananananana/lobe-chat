...
export const getFileConfig = () => {
  ...
  return createEnv({
    ...
    runtimeEnv: {
      ...
      OSS_SESSION_TOKEN: process.env.ALIBABA_CLOUD_SECURITY_TOKEN,
      S3_ACCESS_KEY_ID: process.env.S3_ACCESS_KEY_ID || process.env.ALIBABA_CLOUD_ACCESS_KEY_ID,
      S3_BUCKET: process.env.S3_BUCKET,
      S3_ENABLE_PATH_STYLE: !!process.env.S3_ACCESS_KEY_ID && !!process.env.S3_SECRET_ACCESS_KEY,
    ...
    server: {
      ...
      // S3
      OSS_SESSION_TOKEN: z.string().optional(),
